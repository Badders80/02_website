      ...
      <div className="w-full max-w-sm">
        ...
        <div className="mt-8 rounded-2xl border border-white/[0.06] bg-panel p-6">
          ...
          <button
            ...
            className="mt-4 w-full flex items-center justify-center gap-3 rounded-lg bg-white text-gray-900 font-medium py-3 px-4 transition-all duration-200 shadow-lg hover:shadow-xl disabled:cursor-not-allowed disabled:opacity-60"
          >
            {googleLoading ? (
