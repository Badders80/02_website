...
**Evolution Stables – Almanzor x Night Danza (unnamed) (NZ)**  
...
## 2. Object
The object of the Syndicate is to lease and race **Almanzor x Night Danza (unnamed)** as a recreational pursuit, with all syndicate members holding digital leasehold shares for a fixed **36-month** term, as described in the Product Disclosure Statement.
...
## 4. Syndicate Shares
The Syndicate is divided into **20** digital shares of **0.25%** each, representing a **5%** leasehold interest in Almanzor x Night Danza (unnamed) for the Lease Term. Each Shareholder’s rights and obligations are proportional to their shareholding.
...
Token holders are entitled to a share of revenue generated by Nellie during the lease period attributable to the syndicate stake, proportional to their leased stake. Default disclosed split: **75%** to syndicate participants, remainder to lessor/structure as in the PDS.
